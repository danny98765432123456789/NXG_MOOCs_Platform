...
function receive(sp, anchor, devices) {
  ...
  setTimeout(function() {
    ...
    // receivedPacket = Math.random() > 0.5 ? anchor.genPacket(devices[0]) :
...
function move(device) {
  ...
  //   device.loc[0] = 10;
  //   device.loc[1] = 5;
  // } else if (device.loc[0] == 10 && device.loc[1] == 5) { //left up
  //   device.loc[0] = 5;
  //   device.loc[1] = 10;
  // }
  // else if (device.loc[0] == 5 && device.loc[1] == 10) { //right up
  //   device.loc[0] = 5;
  //   device.loc[1] = 5;
  // }
  // else if (device.loc[0] == 15 && device.loc[1] == 0) { //right down
  //   device.loc[0] = 5;
  //   device.loc[1] = 5;
  // }
  // console.log(device);
